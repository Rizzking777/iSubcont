...
checkAuth('archive_vendor'); // cek apakah sudah login dan punya akses ke menu ini

$nik = $_SESSION['nik_user'];
$username = $_SESSION['username'];

$users = mysqli_query($conn, "SELECT * FROM tbl_vendor WHERE is_deleted = '1' ORDER BY `timestamp` DESC");
...
<head>
    ...
    <title>iSubcont - Archive Vendor</title>
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            <li>
                                                                <form action="./../config/function.php" method="post">
                                                                    ...
                                                                    <button type="submit" name="restore-vendor" class="dropdown-item text-info" onclick="return confirm('Yakin ingin restore data vendor ini?');">
                                                                        <i class="bi bi-arrow-counterclockwise me-2"></i> Restore
                                                                    </button>
                                                                    <button type="submit" name="delete-vendor" class="dropdown-item text-danger" onclick="return confirm('Yakin ingin hapus secara permanent data vendor ini?');">

...
checkAuth('archive_defect'); // cek apakah sudah login dan punya akses ke menu ini

$nik = $_SESSION['nik_user'];
$username = $_SESSION['username'];

$users = mysqli_query($conn, "SELECT * FROM tbl_defect WHERE is_deleted = '1' ORDER BY `timestamp` DESC");
...
<head>
    ...
    <title>iSubcont - Archive Defect</title>
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            <li>
                                                                <form action="./../config/function.php" method="post">
                                                                    ...
                                                                    <button type="submit" name="restore-defect" class="dropdown-item text-info" onclick="return confirm('Yakin ingin restore data defect ini?');">
                                                                        <i class="bi bi-arrow-counterclockwise me-2"></i> Restore
                                                                    </button>
                                                                    <button type="submit" name="delete-defect" class="dropdown-item text-danger" onclick="return confirm('Yakin ingin hapus secara permanent data defect ini?');">

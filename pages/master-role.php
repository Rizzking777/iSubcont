...
checkAuth('master_role'); // cek apakah sudah login dan punya akses ke menu ini

$nik = $_SESSION['nik_user'];
$username = $_SESSION['username'];

// ambil semua role
$sql_roles = "SELECT * FROM roles WHERE is_deleted = '0' ORDER BY role_name ASC";
...
<head>
  ...
  <title>iSubcont - Master Role</title>
...
<body>
        ...
        <div class="modal-content shadow-lg border-0 rounded-3">
          ...
          <div class="modal-header bg-primary text-white">
            <h5 class="modal-title d-flex align-items-center" id="tambahRoleLabel">
              <i class="bi bi-people-fill me-2"></i> Tambah Role
            </h5>
          ...
          <form action="./../config/function.php" method="POST">
            <div class="modal-body">
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" name="role_name" id="role_name" class="form-control" placeholder="Input roles" required>
                </div>
                <div class="col-md-6">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-success" name="submit-role">
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    <?php foreach ($result_roles as $row) : ?>
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <button class="btn btn-sm btn-outline-primary" type="button" id="dropdownMenu<?= $row['id']; ?>" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                              <li>
                                ...
                                <a class="dropdown-item text-primary permissionBtn"
                                  href="#"
                                  data-bs-toggle="modal"
                                ...
                                <form action="./../config/function.php" method="post"
                                  ...
                                  <button type="submit" name="remove-role" class="dropdown-item text-danger">
        ...
        <div class="modal-content shadow-lg border-0 rounded-3">
          ...
          <div class="modal-header text-black" style="background-color: DDDAD0;">
            <h5 class="modal-title d-flex align-items-center" id="editRoleModalLabel">
              <i class="bi bi-people-fill me-2"></i> Edit Role
            </h5>
          ...
          <form action="./../config/function.php" method="POST">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-success" name="update-role">
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <form method="post" action="./../config/function.php">
            <div class="modal-header bg-primary text-white">
              <h5 class="modal-title"><i class="bi bi-shield-lock me-2"></i> Set Role Permissions</h5>
              <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            ...
            <div class="modal-body">
              ...
              <!-- Nama role -->
              <h5 class="fw-bold text-dark mb-2" id="permRoleName"></h5>
              <hr class="mt-0 mb-3">

              <table class="table table-bordered align-middle">
                <thead class="table-light">
                  <tr class="text-center">
                    <th style="width: 70%;">Menu Access</th>
                    <th style="width: 30%;">Allowed</th>
                  </tr>
                </thead>
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-success" name="save-permissions">
                <i class="bi bi-check-circle me-1"></i> Simpan
              </button>
            </div>
          </form>
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      editButtons.forEach(btn => {
        btn.addEventListener("click", function() {
          ...
          const role_name = this.getAttribute("data-role-name");
  ...
  <script>
    document.querySelectorAll('.permissionBtn').forEach(btn => {
      btn.addEventListener('click', function() {
        ...
        fetch(`./../config/get_permissions.php?role_id=${roleId}`)
          .then(res => res.json())
          .then(data => {
            ...
            data.forEach(row => {
              let menuLabel = row.parent_id == 0 ?
                `<strong>${row.menu_name}</strong>` :
                `<span style="padding-left:25px;"> ${row.menu_name}</span>`;

              tbody.innerHTML += `
            <tr>
              <td>${menuLabel}</td>
              <td class="text-center">
                <input type="checkbox" name="perm[${row.menu_id}]" 
                  ${row.allowed == 1 ? 'checked' : ''} 

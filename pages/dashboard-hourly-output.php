...
checkAuth('actual_dashboard'); // cek apakah sudah login dan punya akses ke menu ini
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle text-black" style="background-color: #f0e6d2; padding: 10px 20px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
      <h1 style="font-size: 1.8rem; font-weight: 700; font-family: 'Roboto', sans-serif;">
        Actual Hourly Output Production
      </h1>
    </div>
  ...
  <script>
    $(function() {
      ...
      $.ajax({
        ...
        url: '../config/get_actual_hourly_output.php',
...
${qty}
    ...
    function openHourlyDetail(data) {
      ...
      $("#hourlyDetailTitle").text(
        `Detail Actual Hourly : ${data.hour}, ${processLabel}, NCVS : ${data.ncvs}`
      );
    ...
    `);
      ...
      $.ajax({
        ...
        url: './../config/get_actual_hourly_detail.php',

...
checkAuth('archive_user'); // cek apakah sudah login dan punya akses ke menu ini
...
<head>
    ...
    <title>iSubcont - Archive User</title>
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            <li>
                                                                <form action="./../config/function.php" method="post">
                                                                    ...
                                                                    <button type="submit" name="restore-user" class="dropdown-item text-info" onclick="return confirm('Yakin ingin restore data user ini?');">
                                                                        <i class="bi bi-arrow-counterclockwise me-2"></i> Restore
                                                                    </button>
                                                                    <button type="submit" name="delete-user" class="dropdown-item text-danger" onclick="return confirm('Yakin ingin hapus secara permanent data user ini?');">

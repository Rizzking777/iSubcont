...
checkAuth('log_ncvs'); // cek apakah sudah login dan punya akses ke menu ini
...
if (isset($_POST['filter'])) {
    ...
    if (!empty($tanggal)) {
        ...
        $sql = "SELECT * FROM `tlog_ncvs`
                WHERE DATE(created_at) = '$tanggal'
                ORDER BY created_at DESC;";
    } else {
        // Kalau tanggal kosong, bisa kasih hasil kosong atau fallback semua
        $sql = "SELECT * FROM tlog_ncvs WHERE 1=0"; // tidak tampilkan apa2
    }
...
<head>
    ...
    <title>iSubcont - Logging NCVS</title>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped text-center align-middle">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="text-center">ID NCVS</th>

...
checkAuth('master_ncvs'); // cek apakah sudah login dan punya akses ke menu ini

$nik = $_SESSION['nik_user'];
$username = $_SESSION['username'];

// ambil semua role
$sql_roles = "SELECT * FROM tbl_ncvs WHERE is_deleted = '0' ORDER BY `timestamp` ASC";
...
<head>
  ...
  <title>iSubcont - Master NCVS</title>
        ...
        <div class="modal-content shadow-lg border-0 rounded-3">
          ...
          <div class="modal-header bg-primary text-white">
            <h5 class="modal-title d-flex align-items-center" id="tambahRoleLabel">
              <i class="bi bi-bookmarks me-2"></i> Tambah NCVS
            </h5>
          ...
          <form action="./../config/function.php" method="POST">
            <div class="modal-body">
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  ...
                  <input type="number" name="ncvs" id="ncvs" class="form-control" placeholder="Input ncvs, hanya angka." required>
                </div>
                <div class="col-md-6">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-success" name="submit-ncvs">
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    <?php foreach ($result_roles as $row) : ?>
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <button class="btn btn-sm btn-outline-primary" type="button" id="dropdownMenu<?= $row['id_ncvs']; ?>" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                              <li>
                                <a class="dropdown-item editUserBtn"
                                  ...
                                  data-id="<?= $row['id_ncvs']; ?>"
                                  data-ncvs-name="<?= $row['ncvs']; ?>"
                                  data-description="<?= $row['description']; ?>">
                                  <i class="bi bi-pencil me-2"></i> Edit
                                </a>

                                <form action="./../config/function.php" method="post"
                                  onsubmit="return confirm('Yakin ingin hapus ncvs ini?');">
                                  <input type="hidden" name="id_ncvs" value="<?= htmlspecialchars($row['id_ncvs']); ?>">
                                  <button type="submit" name="remove-ncvs" class="dropdown-item text-danger">
        ...
        <div class="modal-content shadow-lg border-0 rounded-3">
          ...
          <div class="modal-header text-black" style="background-color: DDDAD0;">
            <h5 class="modal-title d-flex align-items-center" id="editRoleModalLabel">
              <i class="bi bi-people-fill me-2"></i> Edit NCVS
            </h5>
          ...
          <form action="./../config/function.php" method="POST">
            <div class="modal-body">
              <div class="row g-3">
                <input type="hidden" name="id_ncvs" id="edit_id">
                <input type="hidden" name="updated_by" id="updated_by" value="<?= htmlspecialchars($username) ?>">

                <div class="col-md-6">
                  <label for="ncvs" class="form-label">NCVS</label>
                  <input type="number" name="ncvs" id="edit_ncvs" class="form-control">
                </div>
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-success" name="update-ncvs">
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      editButtons.forEach(btn => {
        btn.addEventListener("click", function() {
          ...
          const id_ncvs = this.getAttribute("data-id");
          const ncvs = this.getAttribute("data-ncvs-name");
          const description = this.getAttribute("data-description");

          // Isi data ke modal
          document.getElementById("edit_id").value = id_ncvs;

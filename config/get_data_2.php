...
while ($row = $dataResult->fetch_assoc()) {
    $row['job_order'] = '<a href="dashb-timeline-detail.php?job_order=' . urlencode($row['job_order']) . '" class="btn btn-sm btn-outline-primary">' . htmlspecialchars($row['job_order']) . '</a>';
    $data[] = $row;
}
